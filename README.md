...
This is a [Ruby][] implementation of a [SPARQL][] parser for
[RDF.rb][].

* <http://github.com/gkellogg/sparql-grammar>
...
* [SPARQL::Algebra](https://rubygems.org/gems/sparql-algebra) (>= 0.0.4)
